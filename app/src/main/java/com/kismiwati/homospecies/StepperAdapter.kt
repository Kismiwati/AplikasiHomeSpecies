...
import com.kismiwati.homospecies.databinding.CvSteeperItemBinding

//pada bagian ini adalah adapter untuk RecyclerView
class StepperAdapter(val spacies : List<Any>)
    ...
    // pada bagian ini digunakan untuk menemukan dan simpan tampilan dari item
